...
from scipy import stats, optimize  # for confidence_interval computation
...
def proportion_confint(count, nobs, alpha=0.05, method='normal'):
    ...
    if method == 'normal':
        ...
        ci_low = optimize.brentq(func, q_ * 0.1, q_)[0]
        ...
        raise NotImplementedError('method "{}" is not available'.format(method))
