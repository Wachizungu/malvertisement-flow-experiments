...
class Ad:
    ...
    def ad_to_words(self):  # returns a list of words from an ad
        ...
        for i in range(0, len(word_list)):
            word_list[i] = word_list[i].replace('\xe2\x80\x8e', '')
            word_list[i] = word_list[i].replace('\xc2\xae', '')
            word_list[i] = word_list[i].replace('\xe2\x84\xa2', '')
            word_list[i] = word_list[i].replace('\xc3\xa9', '')
            word_list[i] = word_list[i].replace('\xc3\xa1', '')
